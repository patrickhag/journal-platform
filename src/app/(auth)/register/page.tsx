                    ...
                    <form onSubmit={form.handleSubmit(data => {
                        ...
                        <div className="space-y-2">
                            <FormField name='firstName' control={form.control} render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="firstName" className="text-sm text-gray-700">
                                        Firstname *
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <div className="space-y-2">
                            <FormField name='lastName' control={form.control} render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="lastName" className="text-sm text-gray-700">
                                        Lastname *
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <div className="space-y-2">
                            <FormField name='affiliation' control={form.control} render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="affiliation" className="text-sm text-gray-700">
                                        Affiliation *
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <div className="space-y-2">
                            <FormField control={form.control} name='country' render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="country" className="text-sm text-gray-700">
                                        Country *
                                    </FormLabel>
                                    <FormControl>
                                        <Select
                        ...
                        <div className="space-y-2">
                            <FormField name='email' control={form.control} render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="email" className="text-sm text-gray-700">
                                        Email *
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <div className="space-y-2">
                            <FormField name='password' control={form.control} render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="password" className="text-sm text-gray-700">
                                        Password *
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                        ...
                        <div className="space-y-2">
                            <FormField name='confirmPassword' control={form.control} render={({ field }) => (
                                <FormItem>
                                    <FormLabel htmlFor="confirmPassword" className="text-sm text-gray-700">
                                        Confirm Password *
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                                ...
                                <FormItem>
                                    <FormControl>
                                        <div className="flex items-center space-x-2">
                                            <Checkbox {...field} checked={field.value} onCheckedChange={field.onChange} value={undefined} />
                                            <label
                                                htmlFor="terms"
                        ...
                        <Button className="w-full bg-gray-800 hover:bg-gray-700 text-white" type="submit" aria-disabled={isPending}>
                            Register
                        </Button>
                    </form>
                </Form>
