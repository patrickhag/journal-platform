										...
										<FormItem>
											...
											<FormControl>
												<RadioGroup className="flex space-x-4" {...field}>
													<input type="radio" name="funded" value="yes" id="funded-yes" />
													<Label htmlFor="funded-yes">yes</Label>
													<input type="radio" name="funded" value="no" id="funded-no" />
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<RadioGroup className="flex space-x-4" {...field}>
													<input type="radio" name="ethical" value="yes" id="ethical-yes" />
													<Label htmlFor="ethical-yes">yes</Label>
													<input type="radio" name="ethical" value="no" id="ethical-no" />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<RadioGroup className="flex space-x-4" {...field}>
												<input type="radio" name="consent" value="yes" id="consent-yes" />
												<Label htmlFor="consent-yes">yes</Label>
												<input type="radio" name="consent" value="no" id="consent-no" />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<RadioGroup className="flex space-x-4" {...field}>
												<input type="radio" name="human" value="yes" id="human-yes" />
